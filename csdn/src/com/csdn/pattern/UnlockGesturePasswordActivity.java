...
import com.csdn.CSDNApplication;
import com.csdn.R;
import com.csdn.utils.LockPatternUtils;
import com.csdn.view.LockPatternView;
...
public class UnlockGesturePasswordActivity extends Activity {
	...
	protected void onResume() {
		...
		if (!CSDNApplication.getInstance().getLockPatternUtils().savedPatternExists()) {
	...
	protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
		...
		public void onPatternDetected(List<LockPatternView.Cell> pattern) {
			if (pattern == null)
				return;
			if (CSDNApplication.getInstance().getLockPatternUtils().checkPattern(pattern)) {
				mLockPatternView
