...
public class StatusExpandAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		holder.tvGroupName = (TextView) convertView.findViewById(R.id.one_status_name);

		holder.tvGroupName.setText(groupList.get(groupPosition).getGroupName());
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView != null) {
			...
			viewHolder.tvTwoStatusTime = (TextView) convertView
					.findViewById(R.id.tv_two_complete_time);
		}
		viewHolder.tvTwoStatusTime.setText(entity.getCompleteTime());
	...
	private class ChildViewHolder {
		public TextView tvTwoStatusTime;
	}
